...
//		System.out.println("Particles:"+fixtureDef.density);
		fixtureDef.friction = 1250f;// this is surface friction;
	...
	public void draw(Graphics2D g) {
		...
		double mm= x+Math.cos(-ang)*12;
		
		double nn= y+Math.sin(-ang)*12;
		int xx=Double.valueOf(mm).intValue();
		int yy=Double.valueOf(nn).intValue();
